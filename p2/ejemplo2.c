...
int main(int argc, char ** argv){
  ...
  AFNDInsertaEstado(p_afnd,"q1_nohacenada",NORMAL);
  AFNDInsertaEstado(p_afnd,"q2_nohacenada",NORMAL);
  ...
  AFNDInsertaEstado(p_afnd,"q12",NORMAL);
  AFNDInsertaEstado(p_afnd,"q13",NORMAL);
  ...
  AFNDInsertaTransicion(p_afnd, "q12", "1", "q13");
  AFNDInsertaTransicion(p_afnd, "q13", "0", "q12");

  AFNDInsertaTransicion(p_afnd, "q1_nohacenada", "1", "q13");
  AFNDInsertaTransicion(p_afnd, "q1_nohacenada", "0", "q0");
  AFNDInsertaTransicion(p_afnd, "q1_nohacenada", "1", "q6");
  AFNDInsertaTransicion(p_afnd, "q1_nohacenada", "0", "q3");
